...
<head>
    ...
    <style type="text/css">
    	...
    	*
    	...
    	{
    		0%,100%{
    			background:url('https://j.top4top.io/p_2043o70mt1.jpeg') no-repeat;
    			background-size: cover;
    		}
    		25%
    		{
    		...
    		{
    			opacity: 1;
    			background:url('https://i.ibb.co/8MMwCsK/Whats-App-Image-2021-08-06-at-13-43-13.jpg') no-repeat;
    			background-size: cover;
    		}
    		75%
    		{
